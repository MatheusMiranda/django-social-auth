...
urlpatterns = [
    ...
    path(r'get_repositories', repository_views.get_repositories,
         name='get_repositories'),
    path(r'edit_repository_tags/<repository_id>',
         repository_views.edit_repository_tags,
         name='edit_repository_tags'),
    path(r'new_tag/<repository_id>', repository_views.new_tag,
         name='new_tag'),
    path(r'update_repository/<repository_id>',
         repository_views.update_repository,
         name='update_repository'),
    path(r'remove_repository/<repository_id>',
